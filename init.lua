...
vim.opt.guicursor = 'n:ver25,i:ver25,r:hor20,v:block'
...
require('lazy').setup({
  { 'blazkowolf/gruber-darker.nvim' },
  {
    ...
    config = function()
      local my_colors_normal = {
        a = { fg = '#565F73', bg = '#101010' },
      ...
      require('lualine').setup {
        options = {
          theme = {
            normal = my_colors_normal,
            insert = my_colors,
            visual = my_colors,
            replace = my_colors,
            command = my_colors,
            inactive = my_colors_normal, -- 👈 add inactive too
          },
        },
      }
    end,
